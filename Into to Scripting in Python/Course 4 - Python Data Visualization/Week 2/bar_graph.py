...
def make_bar_graph(title, xvals, data1, data2=None, data3=None, data4=None, type='bar'):
    ...
    # build the bar graph
    if type == 'stacked':
        bar_graph = pygal.StackedBar(height=400)
        
    else:
        bar_graph = pygal.Bar(height=400)
...
def make_horizontal_bar(title, data1, data2=None, data3=None, data4=None):
    ...
    """
    # build the bar graph
    bar_graph = pygal.HorizontalBar(height=400)
...
make_horizontal_bar('A Horizontal Bar Graph', my_data, my_other_data)
